        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            <select
              ...
              className="px-4 py-2 bg-slate-800 border border-slate-700 text-white rounded-lg focus:ring-2 focus:ring-pink-500 focus:border-transparent"
            >
            ...
            <button className="px-4 py-2 bg-slate-800 border border-slate-700 text-gray-300 rounded-lg hover:bg-slate-700 transition-colors flex items-center gap-2">
              ...
              return (
                <div key={i}>
                  <div className="flex justify-between text-sm mb-1">
                    ...
                    <span className="text-gray-400">{type.count} ({percentage.toFixed(1)}%)</span>
                  </div>
        ...
        <div className="bg-slate-900 rounded-xl border border-slate-800 overflow-hidden">
          ...
          <div className="divide-y divide-slate-800">
            {topData?.topDonors.map((donor, i) => (
              <div key={donor.id} className="px-6 py-4 flex items-center justify-between hover:bg-slate-800/50">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-500">{donor.city || "N/A"}</p>
                  </div>
                </div>
        ...
        <div className="bg-slate-900 rounded-xl border border-slate-800 overflow-hidden">
          ...
          <div className="divide-y divide-slate-800">
            {topData?.recentLargeDonations.map((donation) => (
              <div key={donation.id} className="px-6 py-4 flex items-center justify-between hover:bg-slate-800/50">
                <div>
                  <p className="text-sm font-medium text-white">{donation.donor}</p>
                  <p className="text-xs text-gray-500">{donation.formName}</p>
                </div>
                <div className="text-right">
                  <p className="text-sm font-semibold text-pink-400">{formatCurrency(donation.amount)}</p>
        ...
        <div className="bg-slate-900 rounded-xl border border-slate-800 overflow-hidden">
          ...
          <div className="divide-y divide-slate-800">
            {topData?.topForms.map((form, i) => (
              <div key={form.id} className="px-6 py-4 hover:bg-slate-800/50">
                ...
                <p className="text-xs text-gray-500 mt-1">{form.donationCount} dons</p>
              </div>
            ))}
              ...
              <div key={i} className="px-6 py-4 flex items-center justify-between hover:bg-slate-800/50">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-500">{city.count} donateurs</p>
                  </div>
                </div>
