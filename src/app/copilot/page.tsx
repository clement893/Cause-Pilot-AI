      ...
      <div className="flex flex-col h-[calc(100vh-120px)]">
        ...
        <div className="mb-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-400">Votre assistant intelligent pour la gestion philanthropique</p>
            </div>
          </div>
        </div>
              ...
              <div className="flex flex-wrap gap-2">
                {suggestions.map((suggestion, i) => (
                  <button
                    ...
                    className="px-3 py-2 bg-slate-800 hover:bg-slate-700 border border-slate-700 rounded-lg text-sm text-gray-300 transition-colors flex items-center gap-2"
                  >
          ...
          <div className="p-4 border-t border-slate-800">
            <form onSubmit={handleSubmit} className="flex gap-3">
              <input
                ...
                className="flex-1 px-4 py-3 bg-slate-800 border border-slate-700 rounded-xl text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent"
                disabled={loading}
              />
              <button
                type="submit"
        ...
        <div className="mt-4 grid grid-cols-2 md:grid-cols-4 gap-3">
          <button
            ...
            className="p-4 bg-slate-900 border border-slate-800 rounded-xl hover:bg-slate-800 transition-colors text-left"
          >
          ...
          >
            ...
            <p className="text-xs text-gray-500">Les meilleurs contributeurs</p>
          </button>
          ...
          >
            ...
            <p className="text-xs text-gray-500">Dernières contributions</p>
          </button>
